		...
		<div class="pi-row">
			...
			<div class="pi-col-sm-9 pi-padding-bottom-40">
					...
					<div class="pi-row">
						...
						<div class="pi-col-sm-8 pi-text-right pi-center-text-xs">
							<ul class="pi-social-icons pi-colored-bg pi-small pi-active-bg pi-jump pi-jump-bg pi-round pi-clearfix">
								<li><a href="http://www.facebook.com/sharer.php?u=http://www.aespmisiones.com/articulos/{{$articulo->url_ceo}}>" class="pi-social-icon-facebook"><i class="icon-facebook"></i></a></li>
				...
				<?php if ($comentarios == 'si') { ?>
								...
								<div class="fb-comments" data-href="http://www.http://aespmisiones.com/articulos/show/{{$url_seo}}" data-numposts="20" data-colorscheme="light"></div>
			...
			<div class="pi-sidebar pi-col-sm-3">
				...
				<div class="pi-sidebar-block pi-padding-bottom-40">
					<h3 class="h6 pi-uppercase pi-weight-700 pi-letter-spacing pi-has-bg pi-margin-bottom-20">
						...
						<a class="twitter-timeline"  href="https://twitter.com/aesp.misiones" data-widget-id="526869237831172096">Tweets por @synservicios</a>
